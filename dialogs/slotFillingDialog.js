...
const { ActivityTypes } = require('botbuilder/lib/index');
const { Dialog } = require('botbuilder-dialogs/lib/index');
...
class SlotFillingDialog extends Dialog {
    /**
     * SlotFillingDialog is a Dialog class for offering slot filling features to a bots.
